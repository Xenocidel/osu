...
namespace osu.Game.Rulesets.Taiko.Mods
{
    ...
    internal interface IGenerateSpeedAdjustments
    {
        ...
        void ApplyToHitRenderer(TaikoHitRenderer hitRenderer, ref List<SpeedAdjustmentContainer> hitObjectTimingChanges, ref List<SpeedAdjustmentContainer> barlineTimingChanges);
    }
}
